...
def main():
    ...
    while True:
        ...
        t_detect = time_module.time() - t_start
        
        if detect_count % 30 == 0:  # Print every 30 detections
            print(f"Detection time: {t_detect:.3f}s | Total frames: {frame_count} | Detected: {detect_count}")
