...
class Config:
    ...
    CONFIRM_FRAMES: int = 1  # Nombre de frames consécutives pour confirmer une détection
    COOLDOWN_SECONDS: float = 50.0  # Délai d'attente avant une nouvelle alerte STOP
