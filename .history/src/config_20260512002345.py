...
class Config:
    ...
    CONFIRM_FRAMES: int = 2  # Nombre de frames consécutives pour confirmer une détection
    COOLDOWN_SECONDS: float = 5.0  # Délai d'attente avant une nouvelle alerte STOP
