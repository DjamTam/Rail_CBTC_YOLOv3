...
def main():
    ...
    while True:
        ...
        with status_lock:
            ...
            shared_status["frames"] = int(kpi["frames"])
            shared_status["elapsed_sec"] = float(kpi["elapsed_sec"])
            shared_status["stop_requests"] = int(kpi["stop_requests"])
            shared_status["uncertain_frames"] = int(kpi["uncertain_frames"])
            shared_status["max_confidence_seen"] = float(kpi["max_confidence_seen"])
